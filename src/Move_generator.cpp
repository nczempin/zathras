...
bitboard_set Move_generator::pregenerate_rays(int direction)
{
...
void Move_generator::generate_castling(const move_visitor& f, int king_square)
{
  //castling:
  //1. check each right
  //2.
  f(Piece::WHITE_KING, king_square, king_square - 2, 0);
  f(Piece::WHITE_KING, king_square, king_square + 2, 0);
}
